...
import {registerMode,setMode,keys} from '../engine.js?v=8b00269a';
import {ctx,clear,txt,blk,cw,W,H} from '../crt.js?v=8b00269a';
import {state,flags,FLAG,verb,CAP} from '../state.js?v=8b00269a';
import {AMBER,DIM,DEEP,WHITE} from '../palette.js?v=8b00269a';
